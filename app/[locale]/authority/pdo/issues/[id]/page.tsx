                    ...
                    <div className="bg-white border-2 border-green-100 rounded-2xl p-5 shadow-lg">
                        ...
                        <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
                            <button
                                ...
                                className={`p-3 rounded-xl font-bold text-white transition-all active:scale-95 flex flex-col items-center justify-center gap-2 ${
                            ...
                            <button
                                ...
                                className={`p-3 rounded-xl font-bold text-white transition-all active:scale-95 flex flex-col items-center justify-center gap-2 ${
                                    !["in_progress", "pdo_assigned"].includes(issue.status)
                                        ? 'bg-gradient-to-r from-gray-400 to-gray-500 cursor-not-allowed'
                            ...
                            <button
                                ...
                                className={`p-3 rounded-xl font-bold text-white transition-all active:scale-95 flex flex-col items-center justify-center gap-2 ${
                                    ["resolved", "escalated", "closed"].includes(issue.status)
                                        ? 'bg-gradient-to-r from-gray-400 to-gray-500 cursor-not-allowed'
