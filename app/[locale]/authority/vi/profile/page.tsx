...
import { Building2, ShieldCheck, MapPin, Mail, Phone, User, FileText, Home, Briefcase } from "lucide-react";
...
export default function AuthorityProfilePage() {
  ...
  const t = useMemo(() => {
    const L: any = {
      en: {
        title: "My Profile",
        subtitle: "Manage your authority account and settings",
        labels: {
          name: "Full Name",
          email: "Email Address",
          phone: "Phone Number",
      ...
      kn: {
        title: "ನನ್ನ ಪ್ರೊಫೈಲ್",
        subtitle: "ನಿಮ್ಮ ಅಧಿಕಾರಿ ಖಾತೆ ಮತ್ತು ಸೆಟ್ಟಿಂಗ್‌ಗಳನ್ನು ನಿರ್ವಹಿಸಿ",
        labels: {
          name: "ಪೂರ್ಣ ಹೆಸರು",
          email: "ಇಮೇಲ್ ವಿಳಾಸ",
          phone: "ಫೋನ್ ಸಂಖ್ಯೆ",
      ...
      hi: {
        ...
        subtitle: "अपने प्राधिकरण खाते और सेटिंग्स प्रबंधित करें",
        labels: {
          name: "पूरा नाम",
          email: "ईमेल पता",
          phone: "फोन नंबर",
      ...
      <div className="min-h-screen bg-gradient-to-b from-blue-50 via-white to-white p-4 pb-24">
        ...
        <div className="profile-card border-2 border-blue-100 rounded-3xl shadow-xl p-6 mb-8 animate-scaleIn delay-400">
          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-center gap-6 mb-8">
            <div className="relative">
              <div className="w-24 h-24 rounded-2xl bg-gradient-to-br from-blue-500 to-cyan-600 flex items-center justify-center shadow-lg">
                <FiUser className="w-12 h-12 text-white" />
              </div>
              {data.verified && (
                <div className="absolute -bottom-2 -right-2 bg-gradient-to-br from-blue-500 to-cyan-600 text-white rounded-full p-2 shadow-lg">
          ...
          <div className="space-y-8">
            ...
            <div className="animate-fadeIn delay-500">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div>
                  <label className="text-sm font-semibold text-blue-800 mb-2 block">{t.labels.aadhaar}</label>
                  <input
            ...
            <div className="animate-fadeIn delay-700">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-4">
                ...
                {data.village && (
                  <div>
                    <label className="text-sm font-semibold text-blue-800 mb-2 block">{t.labels.village}</label>
                    <input
                      value={data.village || ""}
                ...
                {data.panchayat && (
                  <div>
                    <label className="text-sm font-semibold text-blue-800 mb-2 block">{t.labels.panchayat}</label>
                    <input
                ...
                {data.gramPanchayatId && (
                  <div className="sm:col-span-2">
                    <label className="text-sm font-semibold text-blue-800 mb-2 block">{t.labels.gramPanchayatId}</label>
                    <input
            ...
            <div className="animate-fadeIn delay-900">
              ...
              {showSecurity && (
                <div className="bg-gradient-to-r from-blue-50 to-cyan-50 rounded-2xl p-5 border-2 border-blue-100 space-y-4">
                  <div>
                  ...
                  <button
                    ...
                    className="ripple w-full rounded-2xl bg-gradient-to-r from-blue-500 to-cyan-600 text-white py-3 font-bold disabled:opacity-50 transition flex items-center justify-center gap-2"
                  >
                    {changingPassword ? (
                      <>
              ...
              {editing ? (
                <>
                  <button
                    onClick={saveProfile}
                    disabled={saving}
                    className="ripple rounded-2xl bg-gradient-to-r from-blue-500 to-cyan-600 text-white py-4 font-extrabold disabled:opacity-60 active:scale-[0.99] transition flex items-center justify-center gap-3 shadow-lg hover:shadow-xl"
                  >
                ...
                <>
                  <button
                    onClick={() => router.push(`/${locale}/authority/vi/dashboard`)}
                    className="ripple rounded-2xl bg-gradient-to-r from-blue-500 to-cyan-600 text-white py-4 font-extrabold active:scale-[0.99] transition flex items-center justify-center gap-3 shadow-lg hover:shadow-xl"
                  >
        ...
        <div className="fixed bottom-4 left-4 right-4 bg-white/90 backdrop-blur-lg border-2 border-blue-100 rounded-2xl p-2 shadow-xl animate-fadeIn">
          <div className="grid grid-cols-4 gap-1">
            ...
            >
              <FiBriefcase className="w-5 h-5 text-blue-600/70" />
              <span className="text-xs mt-1 font-medium text-blue-700/70">
                {t.issues}
              </span>
            </button>
